...
ghcs = modern_ghcs
    where modern_ghcs  = [ghc843, ghc863, ghc865, ghc881, ghc883, ghc884, ghc8101, ghc901]
...
ghc901 :: (DC.CompilerInfo, InstalledPackageIndex)
ghc901 = (ghc [9,0,1], mkIndex ghc901_pkgs)
...
ghc901_pkgs :: [Cabal.PackageIdentifier]
ghc901_pkgs =
