...
RDEPEND="
	>=dev-haskell/blaze-html-0.5:=[profile?] <dev-haskell/blaze-html-0.10
	...
	checkexternal? (
		>=dev-haskell/http-conduit-2.2:=[profile?] <dev-haskell/http-conduit-2.4
	)
	previewserver? (
	...
	!previewserver? (
		checkexternal? (
			>=dev-haskell/http-types-0.7:=[profile?] <dev-haskell/http-types-0.13
		)
		watchserver? (
			>=dev-haskell/fsnotify-0.2:=[profile?] <dev-haskell/fsnotify-0.5
		)
